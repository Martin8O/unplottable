# Glossary — canonical spellings (gate lints against this)

> Recurring capitalized/invented terms must appear here with their ONE canonical spelling. Seed set below; R/S/W prompts grow it.

## Canon terms (seed)
Apparition · Auror · Azkaban · Butterbeer · Daily Prophet · Death Chamber · Dementor · Department of Mysteries · Diagon Alley · Firewhisky · Floo Network · Galleon/Sickle/Knut · Gringotts · Hall of Prophecy · Hogwarts · Horcrux · ICW (International Confederation of Wizards) · Kingsley Shacklebolt · Legilimency/Occlumency · Ministry of Magic · Muggle-Worthy Excuse Committee · Obliviator · O.W.L.s/N.E.W.T.s · Pensieve · Portkey · Statute of Secrecy (International Statute of Wizarding Secrecy) · St Mungo's · the Veil · Unspeakable · Wizengamot · Wizarding Wireless Network (WWN)

## Canon names & terms added in R1 (canonical spellings)
Andromeda Tonks · Astoria (never "Asteria" — Pottermore settled it) · Bat-Bogey Hex · Ginevra · Holyhead Harpies · Leaky Cauldron · Lorcan & Lysander Scamander · Malfoy Manor · Metamorphmagus · Rolf Scamander · Rose Weasley (never "Granger-Weasley" — CC-only) · Teddy Lupin (never "Edward Remus") · The Quibbler · Weasleys' Wizard Wheezes (note the apostrophe)

## Canon terms added in R2 (canonical spellings)
Accidental Magic Reversal Squad · *A History of Magic* (Bathilda Bagshot) · Arnold Peasegood · Augustus Rookwood · Bertha Jorkins · Broderick Bode · Celestina Warbeck · Decree for the Reasonable Restriction of Underage Sorcery (1875, Paragraph C) · Dementor's Kiss · Foe-Glass · Ford Anglia · *Hogwarts: A History* · Hokey · International Confederation of Warlocks' Statute of Secrecy (formal citation form, OotP ch.8 — the body itself is "…of Wizards") · Janus Thickey Ward · Knight Bus · Mafalda Hopkirk · Marauder's Map · Morfin Gaunt · Obliviator Headquarters · Omnioculars · Potterwatch · Probity Probe · Protean Charm · Quick-Quotes Quill · *Secrets of the Darkest Art* · Secrecy Sensor · Sneakoscope · Supreme Mugwump · Taboo (the name-jinx) · the Trace · Thief's Downfall · Time-Turner · Time Room · Brain Room · Veritaserum
...
**W15 additions:** **the correction** [INV-043] — the group's name for the cell the Cartographer placed (SO 19 55; lower case; never "the answer", never "the message" — they refuse a noun that decides) · **the excuse queue** [INV-043] — the Committee's index of closed Muggle-Worthy Excuses, kept by parish (lower case; "the queue" after first use) · **the Cartographer** — coined in ch15 per the ladder above; capital C, definite article always · **desk run** vs **national pass** [INV-042a/043b] — the group's fortnightly local re-score vs the booked full-country pass (both lower case; the distinction is load-bearing from ch14 on)

**W14 additions:** **the Apparatus** [INV-042] — the rig's *paperwork* name (`Apparatus, Analytical (Muggle-Manufactured), One`); capital A, used by everyone who has not seen it, while the three who have say **the rig** (the two-names motif; both spellings binding) · **canary** [INV-042] — Adam's trade-word for a planted value with no independent source; **trap street** — Orla's registry equivalent (copyists' trap: "a name in a register that never drew breath"); *canary* is the word that sticks, both lower case · **the twin** [INV-042] — the unpublished second fabrication (lower case) · **Magical Maintenance** [Tier-1, OotP ch.7] — supplies the rig's power on a trolley; the box is never explained (mystery rail)
...
## Terms added in W23+W24
**the compartments** / **the compartment canary** [INV-054] — the group's inward-pointed instrument: four holders, four false facts of different kinds, each living in one head only, pre-registered in sealed envelopes lodged unopened in the Department's ledger for one week (lower case; "the compartments" in speech, "the envelopes" for the objects). Extends *canary* (INV-042) and *the reading list* (INV-050): the reading list asks which shelf it reads, the compartments ask whether it reads **us** · **the control arm** [INV-054] — Priya's half-fact: a five-character run tag typed into the world's machines on purpose, so that a positive result names the keyboard rather than a person (lower case; Adam's trade word, and the ethical debt he dates to 21 Nov) · **the substrate reading** [INV-054] — Adam's stated-as-fallible model of where the revenant is: nowhere between runs, whole inside every instantiation, persisting only as the shape the record keeps making — *"everything it has ever known about us, somebody typed"* (lower case; the characters' hypothesis, **not** a world rule — falsified ch25) · **the versions** [INV-055] — Luna's memory practice: dated re-copyings of her own childhood notebook with every later addition marked (lower case; "the first copy" for the 1991 exercise book)

## Terms added in W22
**the maker's mark** [INV-051] — the device Pandora put on every instrument she built: a single narrow crescent, horns to the left (at a keyboard you would read it as a bracket closing); per the 1990 inquest annexe the examiners sorted her apparatus from the household's by it, because she never once signed a working with her name. The fragment signs with the mark, never a name (lower case in prose; "the mark" after first use) · **the ask** [INV-051] — the group's word for the session of 16 September 2033 and its demand (lower case; also ch22's title): the offer's other clauses are revocable packaging, the census is the ask
